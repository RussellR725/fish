...
// Corrected SQL query
$result = $conn->query("SELECT username, fName, lName, trophies, wins, losses, profilepic FROM users ORDER BY trophies DESC");
...
<body class="is-preload">
    ...
    <header id="header">
        ...
        <section id="main" class="container">
            <header>
                <h2>Leaderboard</h2>
                <p>See the top players based on trophies.</p>
            </header>
            <div class="row">
                <div class="col-12">
                    <section class="box">
                            ...
                            <?php if ($result && $result->num_rows > 0): ?>
                                <table>
                                    <tr>
                                        ...
                                        <th style="vertical-align: text-bottom;">Username</th>
                                        <th style="vertical-align: text-bottom;">Name</th>
                                        <th style="vertical-align: text-bottom;">Trophies</th>
                                        <th style="vertical-align: text-bottom;">Wins</th>
                                        <th style="vertical-align: text-bottom;">Losses</th>
                                    </tr>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            <td>
                                                <a href="profile.php?profile=<?= htmlspecialchars($row["username"]) ?>">
                                                    <img src="<?= htmlspecialchars($row["profilepic"]) ?>" width="32" height="32" style="vertical-align: middle" alt="Profile Picture">
                                                </a>
                                            </td>
                                            <td>
                                                <a href="profile.php?profile=<?= htmlspecialchars($row["username"]) ?>">
                                            ...
                                            <td><?= htmlspecialchars($row["trophies"]) ?></td>
