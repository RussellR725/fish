			...
			<!-- Main -->
                <section id="main" class="container">
					<header>
						...
						<p>Terms and Conditions Plus Privacy</p>
					</header>
					<div class="box">
                        <header>
                            <h2>Terms and Conditions</h2>
						...
						<h3>Terms</h3>
						<p>Don't be a dumbass and put an actual password you use here. In case it isn't clear THIS IS NOT A SECURE WEBSITE> SO DONT GO PUTTING YOUR SOCIAL SECURITY NUMBER HERE.</p>
                        <p>Also don't be putting fake data or fake accounts in here or we will ban you and it will cause lots of work for me. So just don't use this sparingly this is basically a joke. Have fun anyways and don't be a bitch.</p>
